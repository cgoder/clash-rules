...
const ruleProviders = {
  ...
  "applications": {
    ...ruleProviderCommon,
    "behavior": "classical",
    "url": "https://fastly.jsdelivr.net/gh/cgoder/clash-rules@main/applications.txt",
    "path": "./ruleset/loyalsoldier/applications.yaml"
  },
  "openai": {
    ...ruleProviderCommon,
    "behavior": "classical",
    "url": "https://fastly.jsdelivr.net/gh/cgoder/clash-rules@main/openai.txt",
  ...
  "netflix": {
    ...ruleProviderCommon,
    "behavior": "classical",
    "url": "https://fastly.jsdelivr.net/gh/cgoder/clash-rules@main/Netflix.txt",
...
function main(config) {
  ...
  config["proxy-groups"] = [
    ...
    },
    {
      ...
      "include-all": true,
      "hidden": false,
      "exclude-filter": "HK|🇭🇰|官网|剩余|到期|重置|域名|🇨🇳|香港|HongKong",
